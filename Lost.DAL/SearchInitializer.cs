...
namespace Lost.DAL
{
    public class SearchInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SearchContext>
    {
        protected override void Seed(SearchContext context)
        {
            ...
            {
                new LostPersonEntity{FirstName="Abdul", LastName="Ghulabudin", Birthday=DateTime.Parse("1978-01-01"), City="Damask", Country="Siria", DateLastSeen=DateTime.Parse("2015-09-25"), LocationLastSeen="Opatovac, Croatia", IsFound=false, ReporterName="Dino", Location="Opatovac, Croatia", ReportDate=DateTime.Parse("2015-09-29"), RedCrossId=1},
                new LostPersonEntity{FirstName="Afsdg", LastName="Rdgjfhk", Birthday=DateTime.Parse("1962-04-01"), City="Damask", Country="Siria", DateLastSeen=DateTime.Parse("2015-09-25"), LocationLastSeen="Opatovac, Croatia", IsFound=false, ReporterName="Dinko", Location="Opatovac, Croatia", ReportDate=DateTime.Parse("2015-10-15"), RedCrossId=1},
            ...
            {
                new RedCrossEntity{Name="GDCK Osijek", City="Osijek", Country="Croatia", PersonInCharge="Goran Latkovic"}
            };
